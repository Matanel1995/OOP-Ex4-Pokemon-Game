...
Eevee_img = pygame.image.load('imgs/eevee.jpeg').convert_alpha()
Eevee_img = pygame.transform.scale(Eevee_img,(radius-10,radius-10))
Magickarp_img = pygame.image.load('imgs/magikarp.jpeg').convert_alpha()
Magickarp_img = pygame.transform.scale(Magickarp_img,(radius-10,radius-10))
Pikachu_img = pygame.image.load('imgs/pikachu.jpeg').convert_alpha()
Pikachu_img = pygame.transform.scale(Pikachu_img,(radius-10,radius-10))
Snorlax_img = pygame.image.load('imgs/snorlax.jpeg').convert_alpha()
Snorlax_img = pygame.transform.scale(Snorlax_img,(radius-10,radius-10))
Squirtle_img = pygame.image.load('imgs/squirtle.jpeg').convert_alpha()
